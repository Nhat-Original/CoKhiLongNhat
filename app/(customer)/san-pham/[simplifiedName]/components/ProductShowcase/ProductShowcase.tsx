...
const ProductShowcase = () => {
  ...
  return (
    <div className="border w-full max-w-md grid gap-2 grid-cols-3 [&_img]:rounded-md">
      {productImages.length === 0 ? (
        <img
          src={productPlaceholder.src}
          alt="product image"
          className="col-span-3 w-full aspect-square object-cover"
        />
        ...
        <>
          ...
          <div className="w-full aspect-square relative">
            <img
              ...
              alt={`product image ${productImages[3].id}`}
              className="w-full aspect-square object-cover"
            />
            <div
              className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center text-white font-semibold text-xl rounded-md"
